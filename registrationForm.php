    ...
    <div class="limiter">
        <div class="wrapper">
            ...
            <form action="registration.php" method="post">
                ...
                <div>
                    <input type="text" class="nameInput" name="name" required/>
                    <label for="nameInput">Name</label>
                </div>

                <div>
                    <input type="text" class="surnameInput" name="surname" required/>
                    <label for="surnameInput">Surname</label>
                </div>

                <div>
                    <input type="text" class="usernameInput" name="username" required/>
                ...
                <div>
                    <input type="text" class="emailInput" name="email" required/>
